...
Beware: Dublin Core is __not__ the only metadata schema. Different catalogs, archives, and fields of inquiry rely on different standards. The way in which  you’re describing your items should reflect the way you want your catalog to interact with the world and the way you want it to be interpreted. 
